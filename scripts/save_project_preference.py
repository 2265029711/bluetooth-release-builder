...
def derive_project_id(display_name: str | None, root_hint: str | None, projects: list[dict]) -> str:
...
def main() -> int:
    ...
    project_id = args.project_id or derive_project_id(args.display_name, args.root_hint, projects)
    ...
    if args.variant_key:
        ...
        if variant is None:
            variant = {
                ...
                "artifact_dir": args.artifact_dir or default_artifact_dir(project["artifact_root"], args.variant_key),
